...
#define debug_dec(data)             do { if (debug_enable) print(data); } while (0)
#define debug_decs(data)            do { if (debug_enable) print(data); } while (0)
#define debug_hex4(data)            do { if (debug_enable) print(data); } while (0)
#define debug_hex8(data)            do { if (debug_enable) print(data); } while (0)
#define debug_hex16(data)           do { if (debug_enable) print(data); } while (0)
#define debug_hex32(data)           do { if (debug_enable) print(data); } while (0)
#define debug_bin8(data)            do { if (debug_enable) print(data); } while (0)
#define debug_bin16(data)           do { if (debug_enable) print(data); } while (0)
#define debug_bin32(data)           do { if (debug_enable) print(data); } while (0)
#define debug_bin_reverse8(data)    do { if (debug_enable) print(data); } while (0)
#define debug_bin_reverse16(data)   do { if (debug_enable) print(data); } while (0)
#define debug_bin_reverse32(data)   do { if (debug_enable) print(data); } while (0)
